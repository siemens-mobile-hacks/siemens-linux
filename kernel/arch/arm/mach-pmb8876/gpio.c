...
static struct pmb8876_pcl pcl_pins[] = {
	...
	{	GPIO_MMC_CD,			PMB8876_GPIO(NO_ALT,	NO_ALT,	MANUAL,	IN,		HIGH,	PUSHPULL,	NONE,		NO_ENAQ)	},
	...
	// F4300108: 00000700  (GPIO_MMC_VCC_EN) [PS=1; DATA=1; DIR=OUT]
	// F4300154: 00008300  (GPIO_MMC_CD) [PS=1; DATA=1; DIR=IN; ENAQ=1]
	// F43001C0: 00000211  (GPIO_MMC_CMD) [PS=0; IS=ALT0; OS=ALT0; DATA=1; DIR=IN]
	// F43001C4: 00000211  (GPIO_MMC_DAT) [PS=0; IS=ALT0; OS=ALT0; DATA=1; DIR=IN]
	// F43001C8: 00000011  (GPIO_MMC_CLK) [PS=0; IS=ALT0; OS=ALT0; DATA=0; DIR=IN]
